...
DATA_DIR=/home/ljh/CSC/Enhanced_Syllable_Feature/data/further_pretrain_data
...
for prefix in  'AI' 'AJ' 'AK' 'AL' 'AM'
do
CUDA_VISIBLE_DEVICES=2   python -u /home/ljh/CSC/Enhanced_Syllable_Feature/further_pretrain/train.py \
  --bert_path $BERT_PATH \
  --data_dir $DATA_DIR \
