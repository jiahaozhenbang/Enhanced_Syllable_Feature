...
from models.modeling_multitask import GlyceBertForMultiTask,Attention_GlyceBertForMultiTask
...
class Attention_CSCTask(pl.LightningModule):
    def __init__(self, args: argparse.Namespace, prefix):
        ...
        self.model = Attention_GlyceBertForMultiTask.from_pretrained(self.bert_dir)
