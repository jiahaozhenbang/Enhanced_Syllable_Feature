...
from models.modeling_multitask import Attention_and_weightLoss_GlyceBertForMultiTask
...
class Attention_CSCTask(pl.LightningModule):
    def __init__(self, args: argparse.Namespace, prefix):
        ...
        self.model = Attention_and_weightLoss_GlyceBertForMultiTask.from_pretrained(self.bert_dir)
...
def main():
    ...
    if i > 0:
        model = Attention_CSCTask.load_from_checkpoint(
            os.path.join(
        ...
        model = Attention_CSCTask(args, prefix)
