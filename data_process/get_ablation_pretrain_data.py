...
class hanzi2pinyin():
    ...
    def convert_sentence_to_pinyin_label(self, sentence: str, tokenizer_output: tokenizers.Encoding) -> List[List[int]]:
        # get pinyin of a sentence
        pinyin_list = pinyin(sentence, style=Style.TONE3, heteronym=True, errors=lambda x: [['not chinese'] for _ in x])
        pinyin_locs = {}
        # get pinyin of each location
...
def create_masked_lm_predictions(tokens, masked_lm_prob, vocab_words, rng, text, encoded, tokenizer):
    ...
    label = encoded.ids
    pinyin_label = token2pinyin.convert_sentence_to_pinyin_label(
        text, encoded)
...
if __name__ == "__main__":
    main()
"""
python /home/ljh/CSC/Enhanced_Syllable_Feature/data_process/get_ablation_pretrain_data.py \
    --input_data_dir /home/ljh/Data/wiki_zh --output_txt_dir /home/ljh/CSC/Enhanced_Syllable_Feature/data \
    --output_dir /home/ljh/CSC/Enhanced_Syllable_Feature/data/ablation_pretrain_data --adjust_confusionset
"""