...
if __name__ == '__main__':
    # data = load_test(
    #     input_path='/home/ljh/github/CHINESE_GRC_DATA/NCU_NLPLab_CSC/sighan8csc_release1.0/Test/SIGHAN15_CSC_TestInput.txt',
    #     label_path='/home/ljh/github/CHINESE_GRC_DATA/NCU_NLPLab_CSC/sighan8csc_release1.0/Test/SIGHAN15_CSC_TestTruth.txt',
    #     year=15,
    # )

    # data = load_test(
    #     input_path='/home/ljh/github/CHINESE_GRC_DATA/NCU_NLPLab_CSC/clp14csc_release1.1/Test/CLP14_CSC_TestInput.txt',
    #     label_path='/home/ljh/github/CHINESE_GRC_DATA/NCU_NLPLab_CSC/clp14csc_release1.1/Test/CLP14_CSC_TestTruth.txt',
    #     year=14,
    # )

    data = load_test(
        input_path='/home/ljh/github/CHINESE_GRC_DATA/NCU_NLPLab_CSC/sighan7csc_release1.0/FinalTest/FinalTest_SubTask2.txt',
        label_path='/home/ljh/github/CHINESE_GRC_DATA/NCU_NLPLab_CSC/sighan7csc_release1.0/FinalTest/FinalTest_SubTask2_Truth.txt',
        year=13,
    )
    ...
    # write_data(
    #     data=data,
    #     input_path='/home/ljh/CSC/Enhanced_Syllable_Feature/data/test.sighan15.tsv',
    #     label_path='/home/ljh/CSC/Enhanced_Syllable_Feature/data/test.sighan15.lbl.tsv',
    # )

    # write_data(
    #     data=data,
    #     input_path='/home/ljh/CSC/Enhanced_Syllable_Feature/data/test.sighan14.tsv',
    #     label_path='/home/ljh/CSC/Enhanced_Syllable_Feature/data/test.sighan14.lbl.tsv',
    # )

    write_data(
        data=data,
        input_path='/home/ljh/CSC/Enhanced_Syllable_Feature/data/test.sighan13.tsv',
        label_path='/home/ljh/CSC/Enhanced_Syllable_Feature/data/test.sighan13.lbl.tsv',
    )
