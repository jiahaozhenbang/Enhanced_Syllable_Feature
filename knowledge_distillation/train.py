...
from models.modeling_multitask import GlyceBertForMultiTask,Attention_GlyceBertForMultiTask,Attention_and_weightLoss_GlyceBertForMultiTask, \
                                            Dynamic_GlyceBertForMultiTask,Dynamic_GlyceBertForMultiTask_with_KD
...
MODEL_MAP = {'ORINGIN': GlyceBertForMultiTask, 
        ...
        'Dynamic_PRON_LOSS_with_KD': Dynamic_GlyceBertForMultiTask_with_KD
        }
...
def get_parser():
    ...
    parser.add_argument("--model_architecture", choices=list(MODEL_MAP.keys()), default="Dynamic_PRON_LOSS_with_KD", type=str,)
