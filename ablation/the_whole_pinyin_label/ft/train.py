...
from models.modeling_multitask import GlyceBertForAblation
from utils.random_seed import set_random_seed
from datasets.collate_functions import collate_to_max_length_with_id,collate_to_max_length_with_id_for_Ablation
...
class CSCTask(pl.LightningModule):
    def __init__(self, args: argparse.Namespace):
        ...
        self.model = GlyceBertForAblation.from_pretrained(self.bert_dir)
    ...
    def train_dataloader(self) -> DataLoader:
        ...
        dataloader = DataLoader(
            ...
            collate_fn=partial(collate_to_max_length_with_id_for_Ablation, fill_values=[0, 0, 0, 0]),
            drop_last=False,
        )
        return dataloader
...
def get_parser():
    ...
    parser.add_argument(
        "--label_file",
        default="/home/ljh/CSC/Enhanced_Syllable_Feature/data/ablation_ft_data/dev15.lbl",
        type=str,
        help="label file",
    )
