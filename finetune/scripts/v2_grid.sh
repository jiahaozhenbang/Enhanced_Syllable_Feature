...
do
    ...
    do
        for bs in 64
        do
            OUTPUT_DIR=/home/ljh/CSC/Enhanced_Syllable_Feature/outputs/finetune/v2_acc1/epoch${epoch}lr${lr}bs${bs}
            mkdir -p $OUTPUT_DIR
            CUDA_VISIBLE_DEVICES=6 python -u /home/ljh/CSC/Enhanced_Syllable_Feature/finetune/train.py \
            --bert_path $BERT_PATH \
            --data_dir $DATA_DIR \
