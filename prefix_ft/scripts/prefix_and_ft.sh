...
OUTPUT_DIR=/home/ljh/CSC/Enhanced_Syllable_Feature/outputs/finetune/prefix_ft/prefixlen${preseqlen}_epoch${epoch}
mkdir -p $OUTPUT_DIR
CUDA_VISIBLE_DEVICES=2 python -u /home/ljh/CSC/Enhanced_Syllable_Feature/prefix_ft/prefix_and_finetuning.py \
--preseqlen $preseqlen \
--bert_path $BERT_PATH \
--data_dir $DATA_DIR \
