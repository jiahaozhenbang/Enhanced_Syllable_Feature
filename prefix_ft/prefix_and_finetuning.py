...
from models.prefixTuning import PrefixTuning
...
class PrefixCSC(pl.LightningModule):
    def __init__(self, args: argparse.Namespace, **kwargs):
        ...
        # some extra stuff.
        config_prefix.mid_dim = self.args.mid_dim
        ...
        if "prefixModel_name_or_path" in self.args and  self.args.prefixModel_name_or_path is not None:
            ...
            self.model = PrefixTuning.from_pretrained(self.args.prefixModel_name_or_path,
                        cache_dir=cache_dir,
    ...
    def validation_epoch_end(self, outputs):
        ...
        self.log('mid_dim', self.args.mid_dim)
...
def get_parser():
    ...
    parser.add_argument('--mid_dim', type=int, default=768, help='')
...
def main():
    ...
    checkpoint_callback = ModelCheckpoint(
        ...
        filename="{prefixlen}{mid_dim}{epoch}-{df:.4f}-{cf:.4f}",
